...
if(!empty($_SESSION['cart'])){
	?>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="cart-romove item">chọn</th>
                                            <th class="cart-description item">img</th>
                                            <th class="cart-product-name item">tên sp</th>

                                            <th class="cart-qty item">số lượng</th>
                                            <th class="cart-sub-total item">Giá</th>
                                            <th class="cart-sub-total item">vận ch</th>
                                            <th class="cart-total last-item">tổng xi</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
...
?>
                                            ...
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo " ".$row['productPrice']; ?>.000vnd</span>
                                            </td>
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo ""." ".$row['shippingCharge']; ?>.000vnd</span>
                                            </td>

                                            <td class="cart-product-grand-total"><span
                                                    class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.000</span>
                                            </td>
                                        </tr>
...
?>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Address">Địa chỉ thanh
                                                    toán<span>*</span></label>
                                ...
                                <tr>
                                    <td>
                                        <div class="cart-checkout-btn pull-right">
                                            <button type="submit" name="ordersubmit" class="btn btn-primary">tiếp tục
                                                thanh toán</button>

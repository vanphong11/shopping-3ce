...
{?>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">Tên sp</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">sp công ty</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">mô tả sp</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">Trạng thái sp</label>
                                        <div class="controls">
                                            <select name="productAvailability" id="productAvailability"
                                                class="span8 tip" required>
                                                <option value="">chọn</option>
                                                <option value="In Stock">còn hàng</option>
                                                <option value="Out of Stock">ko còn hàng</option>
                                            </select>
                                        </div>
                                    </div>

...
?>
                            ...
                            <div class="form-group">
                                <label class="info-title" for="exampleInputPassword1">mk <span>*</span></label>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form class="register-form outer-top-xs" role="form" method="post" name="register"
                            ...
                            <div class="form-group">
                                <label class="info-title" for="contactno"> SĐT. <span>*</span></label>
                                <input type="text" class="form-control unicase-form-control text-input" id="contactno"
                                    name="contactno" maxlength="10" required>
                            </div>

                            <div class="form-group">
                                <label class="info-title" for="password">mk. <span>*</span></label>
                                <input type="password" class="form-control unicase-form-control text-input"
                                    id="password" name="password" required>
                            </div>

                            <div class="form-group">
                                <label class="info-title" for="confirmpassword">nhập lại mk. <span>*</span></label>
                                <input type="password" class="form-control unicase-form-control text-input"

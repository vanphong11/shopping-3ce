<div class="top-bar animate-dropdown">
    ...
    {   ?>
                    <li><a href="#"><i class="icon fa fa-user"></i>Chào mừng
                            -<?php echo htmlentities($_SESSION['username']);?></a></li>
                    <?php } ?>

                    <li><a href="my-account.php"><i class="icon fa fa-user"></i>Tài khoản</a></li>
                    <li><a href="my-wishlist.php"><i class="icon fa fa-heart"></i>Danh sách thích</a></li>
            ...
            <div class="cnt-block">
                <ul class="list-unstyled list-inline">
                    <li class="dropdown dropdown-small">
                        <a href="track-orders.php" class="dropdown-toggle"><span class="key">Theo dỏi đơn hàng</b></a>
                    </li>
                </ul>
            </div>

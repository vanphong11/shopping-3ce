...
?>
                                                <form class="register-form" role="form" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="Billing State ">Trạng thái thanh
                                                            toán <span>*</span></label>
                                                        <input type="text"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="Billing City">Thanh toán thành
                                                            phố <span>*</span></label>
                                                        <input type="text"
                                                            class="form-control unicase-form-control text-input"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="info-title" for="Billing Pincode">Mã thanh toán
                                                            <span>*</span></label>
                                                        <input type="text"
                                                            class="form-control unicase-form-control text-input"
...
?>
                                        ...
                                        <form class="register-form" role="form" method="post">
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing State ">vận chuyển
                                                    <span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing City">vận chuyển Tp.
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Pincode">mã vận chuyển
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
